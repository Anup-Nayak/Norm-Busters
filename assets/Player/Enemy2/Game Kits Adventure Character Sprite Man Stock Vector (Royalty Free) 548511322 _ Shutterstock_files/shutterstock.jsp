				...
				if (!usi_app.suppress_page) {
					...
					if (usi_app.is_image_page || usi_app.is_image_in_cart) {
						...
						if (usi_date.is_after('2099-12-31') && usi_app.check_sub_total_price(threshold) && (usi_app.is_flexable || (usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)))) {
							...
							if (usi_app.messaging && usi_app.messaging.header1) {
								if (usi_app.is_enabled) {
									...
									if (split > 0.5) {
										// Current Designs
										if ((usi_app.is_cart_page && usi_cookies.value_exists('usi_prod_name_1'))  || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "UZvYOyA7T5NzpIxClOSP3vQ", param2 = "50033";
										...
										// Animated Designs
										if ((usi_app.is_cart_page && usi_cookies.value_exists('usi_prod_name_1')) || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "ziuKBX8BrD5aXev6VAgkVb8", param2 = "51479";
						...
						if (usi_app.is_enabled) {
							...
							if (split > 0.5) {
								// Current Designs
								if ((usi_app.is_cart_page && usi_cookies.value_exists('usi_prod_name_1')) || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "HjP45w1uI1rEmyYJYJhvuPq", param2 = "50041";
								...
								// Animated Designs
								if ((usi_app.is_cart_page && usi_cookies.value_exists('usi_prod_name_1'))  || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "Spz84Gg6BKEn2OO5OQKcrXv", param2 = "51483";
						...
						if (usi_date.is_after('2099-12-31') && usi_app.check_sub_total_price(threshold) && (usi_app.is_flexable || (usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)))) {
							...
							if (usi_app.is_enabled) {
								...
								if (split > 0.5) {
									// Current Designs
									if ((usi_app.is_cart_page && usi_cookies.value_exists('usi_prod_name_1')) || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "HjI9e8zWU7neblpiN3ExoiF", param2 = "50037";
									...
									// Animated Designs
									if ((usi_app.is_cart_page && usi_cookies.value_exists('usi_prod_name_1')) || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) param1 = "XukyG8A2RtIZaX0zUGjrMix", param2 = "51487";
